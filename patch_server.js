...
const ttsBlock = code.substring(code.indexOf('app.post(\'/api/tts/elevenlabs\''), code.indexOf('app.post(\'/api/tts\''));

// We want to add Scribe API call after we get audioBuffer
