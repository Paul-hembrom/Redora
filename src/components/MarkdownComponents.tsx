...
export const markdownComponents = {
  ...
  ul: ({node, ...props}: any) => <ul style={{paddingLeft: '1rem', marginBottom: '0.8rem', listStyleType: 'disc', listStylePosition: 'inside', whiteSpace: 'pre-wrap'}} {...props} />,
  ol: ({node, ...props}: any) => <ol style={{paddingLeft: '1rem', marginBottom: '0.8rem', listStyleType: 'decimal', listStylePosition: 'inside', whiteSpace: 'pre-wrap'}} {...props} />,
