    ...
    <div className="min-h-screen bg-[#050505] flex w-full font-sans text-white overflow-hidden" onMouseMove={handleMouseMove}>
      ...
      >
        ...
        >
          ...
          >
            Create your enterprise workspace and unlock the power of AI-assisted document analysis.
          </motion.p>
        </motion.div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative z-10 bg-[#0a0a0a] lg:bg-transparent lg:border-l lg:border-white/5">
        <div className="w-full max-w-md">
          ...
          >
            <h2 className="font-display text-3xl font-semibold mb-2">Create workspace</h2>
            <p className="text-white/50 mb-8 font-light">Set up your account to start analyzing documents.</p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <label className="block text-[11px] font-mono text-white/40 mb-2 uppercase tracking-widest">Full Name</label>
              <input
                type="text"
                required
                value={name}
          ...
          >
            ...
            <button onClick={onSwitchToLogin} className="text-white hover:text-cyan-400 transition-colors font-medium">
              Log in
            </button>
          </motion.p>
        </div>
