    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#141414] border border-neutral-800 rounded-2xl p-8 shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-neutral-500 text-sm mt-2">Sign in to your account to continue</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-neutral-500">
          ...
          <button onClick={onSwitchToSignup} className="text-emerald-400 hover:text-emerald-300 transition-colors">
            Create one
          </button>
        </p>
      </div>
